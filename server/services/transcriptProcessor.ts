...
const responseJsonSchema = {
  ...
  properties: {
    ...
    category: { type: 'string', description: 'Broad municipal service category in lowercase kebab-case.' },
    ...
    actionable: { type: 'boolean', description: 'True only when municipal staff should investigate, repair, clean, enforce, or otherwise act.' },
    ...
    observations: {
      type: 'object', description: 'Relevant facts from the transcript. Never invent details.',
...
const systemInstruction = `You classify completed municipal 311 call transcripts for an operator dashboard.
